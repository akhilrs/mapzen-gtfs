...
class Feed(object):
    ...
    def agencies(self):
        return self._entities('agency')

    def agency(self, key):
        return self._entity('agency', key)

    def routes(self):
        return self._entities('routes')

    def route(self, key):
        return self._entity('routes', key)

    def stops(self):
        return self._entities('stops')

    def stop(self, key):
        return self._entity('stops', key)

    def trips(self):
        return self._entities('trips')

    def trip(self, key):
        return self._entity('trips', key)

    def fares(self):
        return self._entities('fare_attributes')

    def fare(self, key):
        return self._entity('fare_attributes', key)

    def fare_rules(self):
        return self._entities('fare_rules')

    def service_periods(self):
        return self._entities('calendar')

    def service_period(self, key):
        return self._entity('calendar', key)

    def service_exceptions(self):
        return self._entities('calendar_dates')

    def stop_times(self):
        return self._entities('stop_times')

    def transfers(self):
        return self._entities('transfers')

    def frequencies(self):
        return self._entities('frequencies')

    def feed_infos(self):
        return self._entities('feed_info')

    # backwards compat
    def serviceperiods(self):
        return self.service_periods()

    def serviceperiod(self, key):
        return self.service_period(key)
